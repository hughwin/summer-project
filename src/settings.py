...
INPUT_DIR = BASE_DIRECTORY / "input"
RESOURCES_FOLDER = BASE_DIRECTORY / "resources"
DAILY_DIR = BASE_DIRECTORY / "daily"
DAILY_IMAGE = str(BASE_DIRECTORY / "daily" / "image.jpeg")
HISTOGRAM_JPEG = (str(INPUT_DIR / "histogram-{}.jpeg"))
IMAGE_INPUT = str(INPUT_DIR / "{}")
PNG_OUTPUT = str(INPUT_DIR / "{}.png")
JPEG_OUTPUT = str(INPUT_DIR / "{}.jpeg")
